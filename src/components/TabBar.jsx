...
const TabBar = () => {
    ...
    return (
      ...
      backdrop-blur-xl border-t border-gray-700 z-50 shadow-2xl">
            ...
            <div className="flex overflow-x-auto no-scrollbar py-3 px-3 max-w-full space-x-4">
                {tabs.map(({ path, icon: Icon, label, color }) => {
                    ...
                    return (
                        <button
                            ...
                            className={`flex flex-col items-center space-y-1 p-2 rounded-2xl transition-all duration-300 shrink-0
                ${isActive
